    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(v -> {
            ...
            if (title.isEmpty() || priceStr.isEmpty() || id == -1 || selectedImageUri == null) {
                Toast.makeText(this, "Нужно заполнить все поля и выбрать фотографию", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try{
                ...
                Toast.makeText(this, "Цена менять дадада", Toast.LENGTH_SHORT).show();
            }
        });
